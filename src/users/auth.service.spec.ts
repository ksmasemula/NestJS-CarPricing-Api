...
describe('AuthService', () => {
    ...
    it('can create a new user with a salted and hashed password', async () => {
        const user = await service.singup('asdf@adsdf.com', 'asdf');
    ...
    it('returns a user if correct password is provided',async () => {
       await service.singup('asdf@asdf.com', 'mypasswrd');
       
       const user = await service.signin('asdf@asdf.com', 'mypasswrd');
